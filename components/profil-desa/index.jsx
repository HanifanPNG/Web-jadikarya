...
import LembagaSection from "./lembaga-section";
import { getLembagaDynamic } from "@/lib/queries";

export default async function ProfilDesaPage() {
  const dynamicRows = await getLembagaDynamic();
  const dynamicMap = {};
  dynamicRows.forEach((row) => {
    dynamicMap[row.key] = row;
  });
    ...
    <>
        ...
        <div className="relative z-10 w-full px-6 sm:px-12 lg:px-16">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
            ...
            <div className="lg:sticky lg:top-[100px] self-start text-center lg:text-left">
              ...
              >
                Profil <br /> Desa <span className="text-yellow-500 font-lobster">Jadikarya</span>
              </h1>
              <p
      ...
      <div className="relative">
        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-10 lg:px-16 py-16 space-y-10 sm:space-y-12">
          ...
          ══════════════════════════════════════════════════ */}
          <LembagaSection dynamicMap={dynamicMap} />
